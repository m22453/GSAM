...
if args.data == 'aminer':
    if args.align_view_type == 0:
        embeddings_m = backbone_m(v_lst[2]) # main view embedding
        ...
        #         }
        v_index = args.view_index
        embeddings_m = backbone_m(v_lst[2]) # main view
        embeddings_a = backbone_m(v_lst[v_index]) 
